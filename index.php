...
<section class="py-5">
    <div class="container-fluid">
                ...
                <div class="card h-100 course-card-modern">
                    ...
                    <div class="card-body d-flex flex-column">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            ...
                            <span class="badge bg-primary"><?php echo $curso['total_aulas']; ?></span>
                        </div>
                        
                        <p class="card-text text-muted mb-3"><?php echo htmlspecialchars(substr($curso['descricao'], 0, 100)) . (strlen($curso['descricao']) > 100 ? '...' : ''); ?></p>
                        
                        <div class="course-meta mb-3">
                            <div class="d-flex align-items-center text-muted small">
                                <i class="fas fa-user me-2"></i>
                                <span><?php echo htmlspecialchars($curso['gestor_nome']); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="mt-auto">
                            <a href="curso.php?id=<?php echo $curso['id']; ?>" 
                               class="btn btn-primary w-100">
                                ...
                                <?php echo isset($_SESSION['usuario_id']) ? 'Acessar' : 'Ver Curso'; ?>
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="row mt-5">
            <div class="col-12">
                <h3 class="text-center mb-4">Visão Geral da Plataforma</h3>
            </div>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="card text-center h-100">
                    <div class="card-body">
                        ...
                        <h3 class="fw-bold"><?php echo $stats['total_cursos']; ?></h3>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="card text-center h-100">
                    <div class="card-body">
                        ...
                        <h3 class="fw-bold"><?php echo $stats['total_aulas']; ?></h3>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="card text-center h-100">
                    <div class="card-body">
                        ...
                        <h3 class="fw-bold"><?php echo $stats['total_usuarios']; ?></h3>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="card text-center h-100">
                    <div class="card-body">
                        ...
                        <h3 class="fw-bold"><?php echo $stats['aulas_concluidas']; ?></h3>
                        <p class="text-muted mb-0">Aulas Concluídas</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row mt-4">
            <div class="col-12">
                <div class="card bg-primary text-white">
                    <div class="card-body text-center py-5">
                        <h3 class="mb-3">Comece Hoje Mesmo!</h3>
                        <p class="lead mb-4">Faça login ou cadastre-se para acessar todos os cursos disponíveis</p>
